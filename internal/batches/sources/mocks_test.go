...
type MockGitserverClient struct {
	...
	AncestorAtTimeFunc *GitserverClientAncestorAtTimeFunc
	...
	return &MockGitserverClient{
		...
		AncestorAtTimeFunc: &GitserverClientAncestorAtTimeFunc{
			defaultHook: func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error) {
				panic("unexpected invocation of MockGitserverClient.AncestorAtTime")
			},
		},
		ArchiveReaderFunc: &GitserverClientArchiveReaderFunc{
...
// GitserverClientAncestorAtTimeFunc describes the behavior when the
// AncestorAtTime method of the parent MockGitserverClient instance is
// invoked.
type GitserverClientAncestorAtTimeFunc struct {
	defaultHook func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error)
	hooks       []func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error)
	history     []GitserverClientAncestorAtTimeFuncCall
	mutex       sync.Mutex
}

// AncestorAtTime delegates to the next hook function in the queue and
// stores the parameter and result values of this invocation.
func (m *MockGitserverClient) AncestorAtTime(v0 context.Context, v1 api.RepoName, v2 string, v3 time.Time) (api.CommitID, bool, error) {
	r0, r1, r2 := m.AncestorAtTimeFunc.nextHook()(v0, v1, v2, v3)
	m.AncestorAtTimeFunc.appendCall(GitserverClientAncestorAtTimeFuncCall{v0, v1, v2, v3, r0, r1, r2})
	return r0, r1, r2
}
...
// queue is empty.
func (f *GitserverClientAncestorAtTimeFunc) SetDefaultHook(hook func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error)) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// AncestorAtTime method of the parent MockGitserverClient instance invokes
// the hook at the front of the queue and discards it. After the queue is
// empty, the default hook function is invoked for any future action.
func (f *GitserverClientAncestorAtTimeFunc) PushHook(hook func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *GitserverClientAncestorAtTimeFunc) SetDefaultReturn(r0 api.CommitID, r1 bool, r2 error) {
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *GitserverClientAncestorAtTimeFunc) PushReturn(r0 api.CommitID, r1 bool, r2 error) {
	f.PushHook(func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error) {
		return r0, r1, r2
	})
}

func (f *GitserverClientAncestorAtTimeFunc) nextHook() func(context.Context, api.RepoName, string, time.Time) (api.CommitID, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *GitserverClientAncestorAtTimeFunc) appendCall(r0 GitserverClientAncestorAtTimeFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of GitserverClientAncestorAtTimeFuncCall
// objects describing the invocations of this function.
func (f *GitserverClientAncestorAtTimeFunc) History() []GitserverClientAncestorAtTimeFuncCall {
	f.mutex.Lock()
	history := make([]GitserverClientAncestorAtTimeFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// GitserverClientAncestorAtTimeFuncCall is an object that describes an
// invocation of method AncestorAtTime on an instance of
// MockGitserverClient.
type GitserverClientAncestorAtTimeFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Arg1 is the value of the 2nd argument passed to this method
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c GitserverClientAncestorAtTimeFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0, c.Arg1, c.Arg2, c.Arg3}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c GitserverClientAncestorAtTimeFuncCall) Results() []interface{} {
	return []interface{}{c.Result0, c.Result1, c.Result2}
}
...
// parameter and result values of this invocation.
func (m *MockGitserverClient) GetCommit(v0 context.Context, v1 api.RepoName, v2 api.CommitID) (*gitdomain.Commit, error) {
	r0, r1 := m.GetCommitFunc.nextHook()(v0, v1, v2)
	m.GetCommitFunc.appendCall(GitserverClientGetCommitFuncCall{v0, v1, v2, r0, r1})
	return r0, r1
}
...
// the parent MockGitserverClient instance is invoked and the hook queue is
// empty.
func (f *GitserverClientGetCommitFunc) SetDefaultHook(hook func(context.Context, api.RepoName, api.CommitID) (*gitdomain.Commit, error)) {
	f.defaultHook = hook
}
...
// hook at the front of the queue and discards it. After the queue is empty,
// the default hook function is invoked for any future action.
func (f *GitserverClientGetCommitFunc) PushHook(hook func(context.Context, api.RepoName, api.CommitID) (*gitdomain.Commit, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *GitserverClientGetCommitFunc) nextHook() func(context.Context, api.RepoName, api.CommitID) (*gitdomain.Commit, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// stores the parameter and result values of this invocation.
func (m *MockGitserverClient) RepoCloneProgress(v0 context.Context, v1 api.RepoName) (*protocol.RepoCloneProgress, error) {
...
// method of the parent MockGitserverClient instance is invoked and the hook
// queue is empty.
func (f *GitserverClientRepoCloneProgressFunc) SetDefaultHook(hook func(context.Context, api.RepoName) (*protocol.RepoCloneProgress, error)) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *GitserverClientRepoCloneProgressFunc) PushHook(hook func(context.Context, api.RepoName) (*protocol.RepoCloneProgress, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *GitserverClientRepoCloneProgressFunc) SetDefaultReturn(r0 *protocol.RepoCloneProgress, r1 error) {
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *GitserverClientRepoCloneProgressFunc) PushReturn(r0 *protocol.RepoCloneProgress, r1 error) {
	f.PushHook(func(context.Context, api.RepoName) (*protocol.RepoCloneProgress, error) {
		return r0, r1
	})
}

func (f *GitserverClientRepoCloneProgressFunc) nextHook() func(context.Context, api.RepoName) (*protocol.RepoCloneProgress, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// stores the parameter and result values of this invocation.
func (m *MockGitserverClient) RequestRepoUpdate(v0 context.Context, v1 api.RepoName) (*protocol.RepoUpdateResponse, error) {
	r0, r1 := m.RequestRepoUpdateFunc.nextHook()(v0, v1)
	m.RequestRepoUpdateFunc.appendCall(GitserverClientRequestRepoUpdateFuncCall{v0, v1, r0, r1})
	return r0, r1
}
...
// method of the parent MockGitserverClient instance is invoked and the hook
// queue is empty.
func (f *GitserverClientRequestRepoUpdateFunc) SetDefaultHook(hook func(context.Context, api.RepoName) (*protocol.RepoUpdateResponse, error)) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *GitserverClientRequestRepoUpdateFunc) PushHook(hook func(context.Context, api.RepoName) (*protocol.RepoUpdateResponse, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *GitserverClientRequestRepoUpdateFunc) nextHook() func(context.Context, api.RepoName) (*protocol.RepoUpdateResponse, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
